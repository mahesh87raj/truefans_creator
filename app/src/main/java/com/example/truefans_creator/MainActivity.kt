...
import com.example.truefans_creator.adapters.PostAdapter
import com.example.truefans_creator.databinding.ActivityMainBinding
import com.example.truefans_creator.databinding.LayoutTipBottomSheetBinding
import com.example.truefans_creator.models.CreatorProfile
import com.example.truefans_creator.ui.CreatorViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupViews() {
        ...
        binding.btnTip.setOnClickListener {
            // Updated to open the new SupportCreatorActivity (Screen 1)
